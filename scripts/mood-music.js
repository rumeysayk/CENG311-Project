/**
 * This script dynamically shows a list of songs based on the user's selected mood.
 * It uses:
 * - Manually curated songs for each mood
 * - Additional songs fetched from the Last.fm API using AJAX (via Fetch API)
 * 
 * Features:
 * - Toggleable mood selection panel
 * - Custom playlist generation for moods like happy, sad, love, relax, etc.
 * - Smooth integration of manual and API-provided results
 * 
 * Technologies: Vanilla JS, Fetch API (AJAX), Last.fm API
 */
